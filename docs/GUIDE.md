...
> **Welcome to Service-Track Week 12, Task 3!**
...
| `src/logFormatters.py` | Main source code - **has bugs to fix** |
| `src/structuredLogger.py` | Supporting code - **may also have bugs** |
| `tests/test_logger.py` | Test file - **add your tests here** |
...
### Incident - `src/structuredLogger.py`
**User Report / Alert:**
> "': 10, 'INFO': 20, 'WARN': 30, 'ERROR': 40}"
